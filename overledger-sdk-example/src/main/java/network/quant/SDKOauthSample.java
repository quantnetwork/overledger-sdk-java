...
final class SDKOauthSample {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Some error happened in the demo, make sure you have the config file in the src/main/resources set and the oauth2 values set in the context.properties");
            e.printStackTrace();
        }
