...
static final String partyBRippleAddress = "rHVsZPVPjYJMR3Xa8YH7r7MapS7s5cyqgB";
    ...
    public static void main(String[] args) {
        ...
        String partyAEthereumPrivateKey=""; // you need access to the correct CMK to decrypt
        OlHSMKeyManager hsmKeyManager = new OlHSMKeyManager(kr);
        try {
            //String encryptedPartyAEthereumPrivateKey = hsmKeyManager.encryptPrivateKeyHexString("e352ad01a835ec50ba301ed7ffb305555cbf3b635082af140b3864f8e3e443d3");
